  ...
  return (
    ...
    >
      <div className="w-[90%] max-w-[1200px] mx-auto py-16">
        <h1 className="font-[700] text-[70px] text-white leading-[85.15px] text-center mt-5">
       ...
       <div className="flex justify-center"> <button className="bg-[#011219] text-white mb-5  rounded-full px-16 py-3 mt-12">
          See more{" "}
        </button></div>
      </div>
    </div>
