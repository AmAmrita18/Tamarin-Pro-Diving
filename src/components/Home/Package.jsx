      ...
      <div className="w-[90%] max-w-[1200px] mx-auto md:px-0 px-4 md:pt-32 pt-16 pb-20">
        <div className="flex md:flow-row flex-col justify-between">
          <div className="">
            ...
            <h1 className="text-[#1A1A1A] mt-6  lg:text-[57px] md:text-[50px] text-[40px] md:leading-[59.78px] md:block hidden leading-tight font-[700]">
        ...
        <div className="flex md:flex-row flex-col md:py-20 py-16">
          ...
          <div className="lg:w-[70%] md:w-[65%] lg:pl-24 md:pl-10 pt-10">
        ...
        <div className="flex md:flex-row-reverse flex-col md:pt-16">
          ...
          <div className="md:w-[60%] lg:w-[70%] lg:pr-24 md:pr-10 pt-10">
            <h1 className="text-[#1A1A1A] md:mt-6 md:text-[49px] text-[30px]  md:leading-[59.78px] leading-tight font-[700]">
