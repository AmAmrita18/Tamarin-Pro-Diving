...
import heroImage from "/DivingCoursesHero.png"
const HeroCourses = () => {
  return (
    ...
    style={{
      ...
      backgroundPosition: "center",
        ...
        <div className='w-[90%] max-w-[1200px] mx-auto md:py-44 py-24'>
            <h1 className="font-[700] text-center md:text-[70px] text-[45px] text-white md:leading-[85.15px] leading-tight">Diving Courses</h1>
