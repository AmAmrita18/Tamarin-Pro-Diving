...
const Header = () => {
  ...
  return (
    <div className="w-full ">
      <div className="flex justify-between items-center w-[90%] max-w-[1200px] md:px-0 px-4 pt-14 mx-auto">
        ...
        <div
          className={`space-y-4 w-[85%]  rounded-2xl max-w-[1200px] mx-auto px-4 md:hidden mt-16 py-32 bg-[#022A3A] opacity-95 z-50  ${
            isMenuOpen ? "block fixed top-14 right-0 left-0" : "hidden"
          }`}
         
        >
          
          <ul className=" flex flex-col items-center  lg:gap-x-14 md:gap-x-8  gap-8 text-[20px]  font-[400] text-[#FFFFFF] leading-6">
          <li className="transition-all duration-700 ease-in-out  hover:scale-95 ">
              <NavLink to="/" className={({isActive}) => `${isActive && "font-[700]"}`}>Home</NavLink>
            </li>
            <li className="transition-all duration-700 ease-in-out  hover:scale-95 ">
